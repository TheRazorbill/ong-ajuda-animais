...
* **JavaScript (ES6+):** Interatividade, validação de formulários e consumo de API.
* **iMask.js:** Biblioteca para aplicação de máscaras em campos de formulário.
